...
namespace Brass9.Reflection
{
	public class ReflectionHelper
	{
		...
		public static IEnumerable<Type> GetAllPublicClasses(Assembly project = null)
		{
			Assembly[] assemblies;
			if (project == null)
				assemblies = GetAllAssemblies().ToArray();
			else
				assemblies = new[] { project };
#if DEBUG
			try
			{
#endif
		...
		public static MethodInfo[] GetPublicInstanceMethods<T>(string methodName)
		{
			return GetPublicInstanceMethods<T>(methodName);
		}
		public static MethodInfo[] GetPublicInstanceMethods(Type type, string methodName)
		{
